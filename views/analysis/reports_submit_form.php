...
<div class="f-col-bottom-1">
	<h3><?php echo Kohana::lang('ui_main.information_evaluation');?></h3>
	<div class="report_row">
		<h4><?php echo
		Kohana::lang('ui_main.report_edit_dropdown_1_title');?>:</h4>
	...
	<div class="report_row">
		<h4><?php echo Kohana::lang('ui_main.report_edit_dropdown_2_title');?>:</h4>
